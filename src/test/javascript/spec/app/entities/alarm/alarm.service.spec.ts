    ...
    describe('Alarm Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/alarms';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Alarm', () => {
                service.create(new Alarm(null)).subscribe(received => {
            ...
            it('should update a Alarm', () => {
                service.update(new Alarm(123)).subscribe(received => {
