...
import { IsdLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: IsdLoginModalComponent;
        let fixture: ComponentFixture<IsdLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [IsdLoginModalComponent],
                providers: [
                    {
                ...
                .overrideTemplate(IsdLoginModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(IsdLoginModalComponent);
